...
public static class ShopSaveSystem
{
    ...
    {
        ItemUpgradeManager Jetpack_Refuel_Manager = new ItemUpgradeManager("Jetpack Refuel pipes", "Upgrading the pipes.", 50, SpriteDatabase.RefuelPipes, 1.1f, 9, new Jetpack_Refuel_Buy());
